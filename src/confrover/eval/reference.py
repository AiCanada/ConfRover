...
from confrover.data.dpf.catalog import (
    DpfCatalog,
    DpfFamily,
    count_xtc_frames,
    seqres_from_pdb,
...
from confrover.data.dpf.catalog import _family_from_directory
...
class ReferenceSource:
    ...
    Kept separate from :class:`~confrover.data.dpf.catalog.DpfFamily` because
    ...
    *,
    ...
    Args:
        ...
        validate_against_atom37: cross-check frame 0 of the first replica
            against :func:`confrover.data.io.xtc.xtc_to_atom37`, the function the
...
def _crosscheck_frame0_against_atom37(
    *,
    ...
    return {
        ...
        "against": "confrover.data.io.xtc.xtc_to_atom37",
        "xtc_path": str(xtc_path),
    }
