...
"""Prove ConfRover.from_config builds the real Llama/pairformer trunk.
...
from confrover.model.temporal.llama import FusedLlamaPairformerModule  # noqa: E402


def _model_cfg() -> Path:
    return Path(__file__).resolve().parents[2] / "src/confrover/configs/model/confrover.yaml"
...
def native_train_model():
    ...
    backbone = ConfRover.from_config(str(cfg), seed=0, kv_cache_type="offloaded")
