...
from confrover.data.dpf import DpfCatalog, DpfSplit, build_examples
from confrover.data.dpf.catalog import _replica_member_id, looks_like_atlas_family
from confrover.data.io.pdb import Atom37IndexingError
from confrover.train_policy import DEFAULT_DPF_ROOT
...
def test_atlas_replicas_cannot_cross_splits(tmp_path: Path):
    from confrover.data.dpf.catalog import DpfFamily, DpfMember
    from confrover.data.dpf.split import StructuralLeakError, assert_no_leakage
