...
from confrover.data.dpf import DpfCatalog, DpfSplit
...
def test_catalog_n_frames_must_match_xtc_header(tmp_path):
    from confrover.data.dpf.examples import _member_n_frames
...
def test_a_range_produces_examples_at_several_time_separations(tmp_path):
    ...
    from confrover.data.dpf.examples import build_family_bag
...
def test_scalar_forward_stride_accepts_the_cli_range():
    """CLI default is (1, 1024); ConfRoverTrain must not call int() on it."""
