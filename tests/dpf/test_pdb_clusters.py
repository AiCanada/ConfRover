...
from confrover.data.dpf import DpfCatalog
from confrover.data.dpf.catalog import seqres_from_pdb
from confrover.data.dpf.examples import build_examples
...
def _selection_csv() -> Path:
    return REPO_ROOT / "confrover_cache" / "pdb_cluster_selection.csv"
...
def test_the_real_selection_is_disjoint_from_everything_seen():
    ...
    cache = REPO_ROOT / "confrover_cache"
