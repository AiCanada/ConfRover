...
from confrover.data.msa.msa_loader import MSALoader, _get_query_seqres
from confrover.data.pretrain_repr.openfold import loader as loader_mod
...
def test_a_colliding_dotted_index_keeps_its_unique_suffix(tmp_path, monkeypatch):
    ...
    from confrover.data.msa import mmseq2_colab
