...
from confrover.model.utils.dead_units import (
    find_dead_units,
    revive_dead_units,
)
...
def test_optimizer_detector_reads_the_linear2_second_moment():
    ...
    from confrover.model.utils.dead_units import find_dead_units_from_optimizer
...
def test_splitting_preserves_the_function_exactly():
    from confrover.model.utils.dead_units import split_live_units_into_dead
