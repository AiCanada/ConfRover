...
em = pytest.importorskip("confrover.eval.ensemble_metrics")
...
class FakeWorld:
    """Stand-in for confrover.eval.* plus the generation recipe."""
    ...
    # -- fake confrover.eval.ensemble_metrics -----------------------------
...
def test_broken_backbone_geometry_voids_an_ensemble_the_diversity_band_calls_ok(world):
    """confrover.eval.ensemble_metrics.collapse_verdict reads ONLY
...
def test_the_results_json_records_the_protocol_that_produced_it(world, bench):
    ...
    assert cfg["collapse_verdict_source"] == "confrover.eval.ensemble_metrics.collapse_verdict"
