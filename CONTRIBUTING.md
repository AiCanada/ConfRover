...
Thank you for investing your time in contributing to ConfRover project! 

Read our [Code of Coduct](./CODE_OF_CONDUCT.md) to keep our community approachable and respectable.

This guide details how to use issues and pull requests to improve ConfRover project.
...
If you spot a problem with the problem, [search if an issue already exists](https://github.com/ByteDance-Seed/ConfRover/issues). If a related issue doesn't exist, you can open a new issue using [issue template](https://github.com/ByteDance-Seed/ConfRover/issues/new/choose). 
