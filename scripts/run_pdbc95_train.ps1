...
Set-Location 'A:\Git Hub\ConfRover'

confrover train `
  --output "A:\Git Hub\ConfRover\runs\dpf_base_train_pdbc95" `
  --catalog "A:\Git Hub\ConfRover\confrover_cache\pdbc95_over10_catalog_unique.json" `
