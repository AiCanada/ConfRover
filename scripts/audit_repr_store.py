...
Read-only. Nothing here writes, deletes, or queries the network.
    ...
    py -3.13 scripts/audit_repr_store.py --index confrover_cache/pdbc_seqres_index.csv
"""
...
from confrover.data.msa.mmseq2_colab import _a3m_query  # noqa: E402

DEFAULT_INDEX = REPO_ROOT / "confrover_cache" / "pdbc95_over10_seqres_index.csv"
DEFAULT_REPR = REPO_ROOT / "confrover_cache" / "folding_repr"
DEFAULT_MSA = REPO_ROOT / "confrover_cache" / "msa"
PDBC_INDEX = REPO_ROOT / "confrover_cache" / "pdbc_seqres_index.csv"
