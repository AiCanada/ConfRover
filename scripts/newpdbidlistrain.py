#!/usr/bin/env python3
"""Trainable unique ATLAS PDB IDs never used in ConfRover train/val/test.
...
corroborating -- it is exactly what confrover_cache/atlas_train.csv yields when
...
Current ATLAS has 1938 chains. This module selects chains that are:
  ...
  * sequence length <= 384 (same cap as ConfRover pretrain)
...
Usage:
    ...
    py -3 scripts/newpdbidlistrain.py --write-dir "A:/Git Hub/ConfRover/confrover_cache"
"""
